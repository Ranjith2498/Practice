 ...
 * @author tjainmj
 * 
 * The use of count down latch is, it will make one thread to wait of other threads to complete it's execution
 * Means to which thread we call await method that will wait until countdown become 0
 * We will define the maximun value fo0r countdown latch. we decresing value by one each time by calling countDown()
 * Once latch value becomes 0. then thread awaitng here will start execution.
 *
 */
